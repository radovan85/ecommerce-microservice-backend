...
public class CustomerServiceImpl implements CustomerService {
	...
	private final String CART_SERVICE_URL = "http://CART-SERVICE";
	...
	public CustomerDto addCustomer(RegistrationForm form) {
		...
		String userServiceUrl = USER_SERVICE_URL + "/addUser";
		...
		String cartServiceUrl = CART_SERVICE_URL + "/cart/addCart";
	...
	public void removeCustomer(Integer customerId) {
		...
		String userServiceUrl = USER_SERVICE_URL + "/deleteUser/" + customer.getUserId();
		restTemplate.exchange(userServiceUrl, HttpMethod.DELETE, null, String.class);
		String deleteOrdersUrl = ORDER_SERVICE_URL + "/order/deleteAllByCartId/" + customer.getCartId();
		restTemplate.exchange(deleteOrdersUrl, HttpMethod.DELETE, null, Void.class);
		String deleteCartUrl = CART_SERVICE_URL + "/cart/deleteCart/" + customer.getCartId();
	...
	public CustomerDto getCurrentCustomer() {
		// TODO Auto-generated method stub
		String userUrl = USER_SERVICE_URL + "/currentUser";
