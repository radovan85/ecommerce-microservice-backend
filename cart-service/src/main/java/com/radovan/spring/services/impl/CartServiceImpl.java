...
public class CartServiceImpl implements CartService {
	...
	public CartDto getMyCart() {
		...
		String url = urlProvider.getCustomerServiceUrl() + "/customers/currentCustomer";
	...
	public Float calculateGrandTotal(Integer cartId) {
		...
		for (CartItemDto item : allCartItems) {
			String productUrl = urlProvider.getProductServiceUrl() + "/products/productDetails/" + item.getProductId();
