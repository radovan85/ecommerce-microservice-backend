...
public class TempConverter {
	...
	public CartItemDto cartItemEntityToDto(CartItemEntity cartItem) {
		...
		Optional<ResponseEntity<JsonNode>> productResponseOptional = Optional.ofNullable(deserializeConverter
				.getJsonNodeResponse(PRODUCT_SERVICE_URL + "productDetails/" + cartItem.getProductId()));
