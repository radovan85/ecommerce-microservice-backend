...
public class ProductServiceImpl implements ProductService {
	...
	public ProductDto updateProduct(ProductDto product, Integer productId) {
		...
		List<JsonNode> allCartItems = deserializeConverter
				.getJsonNodeList(CART_SERVICE_URL + "items/allItemsByProductId/" + productId);
		...
		if (!allCartItems.isEmpty()) {
			allCartItems.forEach((item) -> {
				...
				String cartItemUrl = CART_SERVICE_URL + "items/updateItem/" + itemId;
		...
		String cartRefreshUrl = CART_SERVICE_URL + "cart/refreshAllCarts";
	...
	public void deleteProduct(Integer productId) {
		...
		String deleteItemsUrl = CART_SERVICE_URL + "items/clearAllByProductId/" + productId;
